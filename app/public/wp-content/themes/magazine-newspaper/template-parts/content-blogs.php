    ...
    <div class="post-content">
        <figure>
            <?php if ( has_post_thumbnail() ) : ?>
                ...
                <?php else : ?>
                <a href="<?php echo esc_url( get_permalink() ); ?>" rel="bookmark"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/no-image.jpg" title="<?php the_title_attribute(); ?>" alt="<?php the_title_attribute(); ?>" class="img-responsive" /></a>
            <?php endif; ?>  
        ...
        <div class="bottom-info">
            <a href="<?php echo esc_url( get_permalink() ); ?>" rel="bookmark" title="" class="btn btn-primary pull-left"><?php esc_html_e('Read More','magazine-newspaper'); ?> <i class="fa fa-angle-double-right"></i></a>
