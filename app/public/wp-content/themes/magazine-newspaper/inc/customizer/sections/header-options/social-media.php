...
function magazine_newspaper_social_media_sections( $wp_customize ) {
	...
	$wp_customize->add_setting( new Magazine_Newspaper_Repeater_Setting(
		$wp_customize, 'magazine_newspaper_social_media', array(
      'default'     => '',
  ...
  $wp_customize->selective_refresh->add_partial('magazine_newspaper_social_media', array(
    'selector' => '#magazine_newspaper_social_media_sections'
  ));
