...
if ( ! class_exists( 'Magazine_Newspaper_Multi_Check_Control' ) ) {
	...
	class Magazine_Newspaper_Multi_Check_Control extends Wp_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'magazine-newspaper-multi-check', get_template_directory_uri() . '/inc/custom-controls/multicheck/multicheck.css', null );
            wp_enqueue_script( 'magazine-newspaper-multi-check', get_template_directory_uri() . '/inc/custom-controls/multicheck/multicheck.js', array( 'jquery' ), false, true );             
        }
